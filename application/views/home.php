    ...
    <div class="container align-center">
        <div class="row justify-content-md-center">
            <div class="mbr-white col-md-10">
                ...
                <h1 class="mbr-section-title mbr-bold pb-3 mbr-fonts-style display-1">Task Manager&nbsp;</h1>
                
                <p class="mbr-text pb-3 mbr-fonts-style display-5">
                    Visit our fair: enjoy everyday magic!</p>
                <div class="mbr-section-btn"><a class="btn btn-md btn-black display-4" href="https://mobirisethemes.com">BUY TICKETS</a>
                    <a class="btn btn-md btn-white-outline display-4" href="https://mobirisethemes.com">MORE INFO</a></div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="media-container-row">
            ...
            <div class="card p-3 col-12 col-md-6 col-lg-4">
                ...
                <div class="card-box">
                    <h4 class="card-title py-3 mbr-fonts-style display-5">Make fun!</h4>
...
<section class="features11 cid-qvQeLmno0F" id="features11-2" data-rv-view="130">
...
<section class="header1 cid-qvQeOE5Mkr mbr-parallax-background" id="header1-3" data-rv-view="133">
...
<section class="header1 cid-qvQeUVMs6e mbr-parallax-background" id="header1-5" data-rv-view="139">
...
<section class="testimonials1 cid-qvQfGWW3Zl" id="testimonials1-6" data-rv-view="142">
...
<section class="clients cid-qvQfKA3Kov" id="clients-7" data-rv-view="145">
...
<section class="map1 cid-qvQfVaWl7H" id="map1-9" data-rv-view="162">
...
<section class="cid-qvQfZqi2K2" id="social-buttons3-b" data-rv-view="164">
